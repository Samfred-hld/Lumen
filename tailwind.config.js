...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        'display-hero': ['Newsreader', 'Inter', 'serif'],
        'label-caps': ['Work Sans', 'Inter', 'sans-serif'],
        'headline': ['Newsreader', 'Inter', 'serif'],
        'display': ['Newsreader', 'Inter', 'serif'],
        'body-lg': ['Work Sans', 'Inter', 'sans-serif'],
        'title': ['Work Sans', 'Inter', 'sans-serif'],
        'mono-kbd': ["'Fira Code'", 'monospace'],
        'body-sm': ['Work Sans', 'Inter', 'sans-serif'],
        'title-caps': ['Work Sans', 'Inter', 'sans-serif'],
        'mono-number': ["'JetBrains Mono'", "'Fira Code'", 'monospace'],
        'display-sm': ['Newsreader', 'Inter', 'serif'],
        'label': ['Work Sans', 'Inter', 'sans-serif'],
        'data-lg': ["'JetBrains Mono'", 'monospace'],
        'data-md': ["'JetBrains Mono'", 'monospace'],
        'headline-lg': ['Newsreader', 'Inter', 'serif'],
        'headline-md': ['Newsreader', 'Inter', 'serif'],
        'display-lg': ['Newsreader', 'Inter', 'serif'],
        'body-md': ['Work Sans', 'Inter', 'sans-serif'],
      },
      fontSize: {
